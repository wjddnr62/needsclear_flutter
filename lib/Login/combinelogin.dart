...
//                  webViewController.clearCache();
        await flutterWebViewPlugin.reloadUrl(this.url);
...
//                          "http://192.168.100.237/auth_api/users/login") {
  ...
  Future<bool> onWillPop() {
    print("currentUrl WillPop : $currentUrl");
    if ("http://auth.cashlink.kr/auth_api/users/login" == currentUrl ||
        "http://auth.cashlink.kr/auth_api/users/logout" == currentUrl) {
...
//    webViewController.currentUrl().then((value) async {
//      if ("http://auth.cashlink.kr/auth_api/users/login" == value) {
//        DateTime now = DateTime.now();
//        if (currentBackPressTime == null ||
//            now.difference(currentBackPressTime) > Duration(seconds: 2)) {
//          currentBackPressTime = now;
...
////                          "http://192.168.100.237/auth_api/users/login") {
//                      if (url ==
//                          "http://auth.cashlink.kr/auth_api/users/login") {
//                        loginView = true;
//                      } else {
//                        loginView = false;
//                      }
