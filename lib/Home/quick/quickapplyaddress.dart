...
import 'package:needsclear/Home/quick/quickbreakdown.dart';
...
class QuickApplyAddress extends StatefulWidget {
  final String vehicle;
  final String article;
  final String damage;

  QuickApplyAddress({this.vehicle, this.article, this.damage});

  @override
  _QuickApplyAddress createState() => _QuickApplyAddress();
}

class _QuickApplyAddress extends State<QuickApplyAddress> {
  String startAddress = "";
  String endAddress = "";
                              ...
                              child: RaisedButton(
                                onPressed: () {
                                  Navigator.of(context).pushAndRemoveUntil(
                                      MaterialPageRoute(
                                          builder: (context) => QuickBreakdown(
