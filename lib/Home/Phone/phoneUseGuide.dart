...
class PhoneUseGuide extends StatefulWidget {
  @override
  _PhoneUseGuide createState() => _PhoneUseGuide();
}

class _PhoneUseGuide extends State<PhoneUseGuide> {
  @override
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Image.asset(
              "assets/needsclear/resource/guide/phoneUseGuide.png",
              fit: BoxFit.cover,
            ),
            whiteSpaceH(20),
            Container(
